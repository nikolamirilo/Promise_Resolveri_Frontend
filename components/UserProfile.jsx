...
export default function UserProfile({ fullName, image, email }) {
  return (
    <div
      ...
      <div className="mx-auto flex h-auto max-w-4xl flex-wrap items-center py-8 lg:h-screen lg:py-0">
        {/* <!--Main Col--> */}
        <div
          id="profile"
          ...
          <div className="p-4 text-center md:p-12 lg:text-left">
            ...
            <div
              className="z-50 mx-auto block h-48 w-48 rounded-full bg-cover bg-center shadow-xl lg:hidden"
              style={{ backgroundImage: `url(${image})` }}></div>
            <h1 className="pt-8 text-3xl font-bold text-violet-700 lg:pt-0">{fullName}</h1>
            ...
            <p className="pt-8 text-sm text-violet-700">
