...
const Navbar = () => {
  ...
  const { user } = useUser()
  return (
    <nav className="fixed top-0 z-50 w-full border-gray-200 bg-violet-700">
            ...
            {!user ? (
              <>
                <li>
                  <Link
                    href="/auth/sign-in"
                    className="block rounded px-3 py-2 text-white md:bg-transparent md:p-0 md:text-amber-500 "
                    aria-current="page">
                    Sign In
                  </Link>
                </li>
