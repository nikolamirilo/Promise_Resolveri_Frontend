const Footer = () => {
  return (
    <div className="w-full bg-violet-700 text-white">
          ...
          <div className="md:max-w-md lg:col-span-2">
            ...
            <div className="mt-4 lg:max-w-sm">
              <p className="text-deep-purple-50 text-sm">
                Match habits is a platform that will assure you that you are not alone in to your
                fault. Meet the people who will help you overcome yourself bad habits.
              </p>
            </div>
          </div>
